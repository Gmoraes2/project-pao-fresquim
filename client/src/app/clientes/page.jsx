...
export default function ClientesPage() {
  ...
  async function getClientes(params) {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(error, "Erro ao buscar clientes."));
    } finally {
      setIsLoading(false);
    }
  }
  ...
  async function deleteClientes(id) {
    try {
      ...
      toast.error(getApiErrorMessage(error, "Erro ao excluir o cliente."));
    }
  }
  ...
  const handleSaveCliente = async (dadosDoFormulario) => {
    try {
      if (dadosDoFormulario.id) {
        await atualizarCliente(dadosDoFormulario.id, dadosDoFormulario);
        toast.success("Cliente atualizado com sucesso!");
      } else {
        await criarCliente(dadosDoFormulario);
