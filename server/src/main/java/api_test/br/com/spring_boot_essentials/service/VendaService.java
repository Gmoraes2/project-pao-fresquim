...
public class VendaService {
    ...
    public List<VendaResumoDTO> listarTodas() {
        return vendaRepository.listarResumo();
    }
    ...
    public VendaModel calcularTotal(VendaModel vendaModel) {
        ...
        if (vendaModel.getFuncionario() == null || vendaModel.getFuncionario().getId() == null) {
            throw new RegraNegocioException("Venda precisa estar vinculada a um funcionario.");
        }

        vendaModel.setFuncionario(funcionarioRepository.findById(vendaModel.getFuncionario().getId())
                .orElseThrow(() -> new RegraNegocioException("Funcionario nao encontrado: " + vendaModel.getFuncionario().getId())));
    ...
    public String emitirNotaFiscal(VendaModel vendaModel) {
        ...
        if (vendaModel.getFuncionario() != null && vendaModel.getFuncionario().getId() != null
                && vendaModel.getFuncionario().getNome() == null) {
            vendaModel.setFuncionario(funcionarioRepository.findById(vendaModel.getFuncionario().getId())
                    .orElseThrow(() -> new RegraNegocioException("Funcionario nao encontrado: " + vendaModel.getFuncionario().getId())));
        }
        ...
        if (vendaModel.getFuncionario() != null && vendaModel.getFuncionario().getNome() != null) {
            sb.append("Funcionario: ").append(vendaModel.getFuncionario().getNome()).append("\n");
        }
